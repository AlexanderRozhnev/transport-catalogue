...
3. [Запросы построения справочника](#make_requests)
    3.1. [Настройки построителя маршрутов](#router_settings)
    3.2. [Запросы на добавление остановки](#add_stops)
    3.3. [Запрос на добавление автобусного маршрута](#add_buses)
4. [Запросы к транспортному справочнику и формат ответов на них](#stat_requests)
    4.1. [Получение информации о маршруте](#route_info)
    4.2. [Визуализация карты маршрутов](#route_visualization)
    4.3. [Запрос на построение маршрута от остановки к остановке](#routing)
5. [Сборка программы и требования](#make)
6. [Запуск программы и перенаправление ввода-вывода](#run)
    6.1. [Перенаправление ввода-вывода](#std_redirection)
    6.2. [Создание транспортного каталога](#base_init)
    6.3. [Использование сохранённого транспортного каталога для обработки запросов](#stat_requests_run)
