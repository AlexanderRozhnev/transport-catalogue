...
Програма работает в двухстадийном режиме, выбираемом при запуске программы. 
...
## Запросов к транспортному справочнику и формат ответов на них
...
```
_без перенаправления потоков ввода/вывода ввод-вывод осуществляется с консоли_
