...
4. [Настройки построителя маршрутов](#router_settings)
5. [Запросы на добавление остановки](#add_stops)
6. [Запрос на добавление автобусного маршрута](#add_buses)
7. [Запросы к транспортному справочнику и формат ответов на них](#stat_requests)
8. [Получение информации о маршруте](#route_info)
9. [Визуализация карты маршрутов](#route_visualization)
10. [Запрос на построение маршрута от остановки к остановке](#routing)
11. [Сборка программы и требования](#make)
12. [Запуск программы и перенаправление ввода-вывода](#run)
13. [Перенаправление ввода-вывода](#std_redirection)
14. [Создание транспортного каталога](#base_init)
15. [Использование сохранённого транспортного каталога для обработки запросов](#stat_requests_run)
